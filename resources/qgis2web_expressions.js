...
function exp_SetordeRisco_2rule0_eval_expression(context) {
    // "Setor de Risco" = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Setor de Risco')  == 1);
    } else {
        return (feature.get('Setor de Risco')  == 1);
    }
}
...
function exp_SetordeRisco_2rule1_eval_expression(context) {
    // "Setor de Risco" = 2

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Setor de Risco')  == 2);
    } else {
        return (feature.get('Setor de Risco')  == 2);
    }
}
...
function exp_SetordeRisco_2rule2_eval_expression(context) {
    // "Setor de Risco" = 3

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Setor de Risco')  == 3);
    } else {
        return (feature.get('Setor de Risco')  == 3);
    }
}